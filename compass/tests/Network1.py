...
for x in tqdm(range(1000)):
    ...
    expected_max["M3_UPTAKE"] = min(
        model.reactions["R3_pos"].upper_bound, model.reactions["E4_pos"].upper_bound, EXCHANGE_LIMIT
    )
    ...
    expected_max["M2_SECRETION"] = min(model.reactions["E1_pos"].upper_bound, model.reactions["R1_pos"].upper_bound)

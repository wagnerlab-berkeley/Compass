...
def create_model():
    ...
    expected_max["R1_pos"] = min(
        ...
        min(model.reactions["R3_pos"].upper_bound, model.reactions["E3_pos"].upper_bound)
        + min(
    ...
    expected_max["R3_pos"] = min(
        min(model.reactions["R1_pos"].upper_bound, model.reactions["E1_pos"].upper_bound)
        + min(
    ...
    expected_max["R4_pos"] = min(
        ...
        model.reactions["E5_pos"].upper_bound / 2,
        min(model.reactions["R1_pos"].upper_bound, model.reactions["E1_pos"].upper_bound)
        + min(model.reactions["R3_neg"].upper_bound, model.reactions["E3_neg"].upper_bound),
    )
